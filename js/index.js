...
var S = {
  init: function () {
    ...
    if (i !== -1) {
      ...
      S.UI.simulate(
        "#rectangle|#countdown 5|现在是|#Date|#time|亲爱的婷|生日快乐|希望你每天|开开心心|万事如意|没有烦恼|最后...|没有最后了|爱你💗|"
      );
    }
      ...
      function (index) {
        ...
        switch (action) {
          ...
          case "Date":
            ...
            S.Shape.switchShape(S.ShapeBuilder.letter(currentdate));
            break;
          ...
          case "author":
            S.Shape.switchShape(S.ShapeBuilder.letter("From Mcdull"));
            break;
          default:
            S.Shape.switchShape(
              S.ShapeBuilder.letter(current[0] === cmd ? "Mcdull" : current)
            );
        }
